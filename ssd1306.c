...
flash unsigned char image0[1026] =
{
...
void LCD_Goto(unsigned char x, unsigned char y)
{
	...
	LCD_Commmand(COMAND, 0xB + y);//установить адрес начала координат
...
void LCD_Printf(unsigned char* buf, unsigned char size) //выводим строку из буфера
{
	...
	while (*buf!=0)
	{
       ...
       if(size==2)
       {
        if((LCD_X>SSD1306_LCDWIDTH)||(LCD_X<24)){LCD_X=SSD1306_DEFAULT_SPACE;}
        LCD_BigNum(*buf++);
       }
	}
}
